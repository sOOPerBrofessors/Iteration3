...
public class SeaGull extends NPC {
    ...
    public SeaGull(Occupation o, Location location, Personality personality, Faction faction, Inventory inventory, NPCStrategy npcStrategy) {
        super(o, location, personality, faction, inventory, npcStrategy);
        navigation = Navigation.makeAvianNav();
    }
